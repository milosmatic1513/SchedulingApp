...
public class Config {
    ...
    public static String DeviceKeyIdentifier = "dbUULc222IDewfTSJVunoDk782Oc8j3l";
    ...
    public static FaceTecCustomization retrieveConfigurationWizardCustomization() {
        ...
        int buttonColorPressed = Color.parseColor("#a69c9e");

        // For Frame Corner Radius Customization
        int frameCornerRadius = 20;

        // For Cancel Button Customization
        int cancelButtonImage = R.drawable.facetec_internal_cancel;
