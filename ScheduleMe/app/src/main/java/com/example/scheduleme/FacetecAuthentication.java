...
public class FacetecAuthentication extends AppCompatActivity {
    ...
    public void initializeFacetec() {
        messageDisplay.setText(getString(R.string.initializing_face_scanner));
                ...
                if(successful) {
                    ...
                    if (mode == 1) {
                        ...
                        if (latestExternalDatabaseRefID.length() == 0) {
                            Toast.makeText(FacetecAuthentication.this, getString(R.string.enroll_first), Toast.LENGTH_SHORT).show();
                            return;
                        }
